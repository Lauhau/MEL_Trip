            ...
            <div className="space-y-4">
              <div className="grid grid-cols-3 gap-3">
                 <div className="col-span-1">
                   ...
                   <input 
                     ...
                     className="w-full mt-1 p-3 bg-gray-50 dark:bg-slate-700 dark:text-white rounded-xl border border-gray-100 dark:border-slate-600 focus:ring-2 focus:ring-primary outline-none"
                   />
                 </div>
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full mt-1 p-3 bg-gray-50 dark:bg-slate-700 dark:text-blue-400 rounded-xl border border-gray-100 dark:border-slate-600 focus:ring-2 focus:ring-primary outline-none text-sm font-mono text-blue-600"
                />
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full mt-1 p-3 bg-gray-50 dark:bg-slate-700 dark:text-white rounded-xl border border-gray-100 dark:border-slate-600 focus:ring-2 focus:ring-primary outline-none h-20 resize-none"
                />
              </div>
